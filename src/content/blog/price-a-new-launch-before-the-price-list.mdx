...
Those five are the ones the budget reaches. If you want to put any three buildings against each other — these, or somewhere else entirely — the same public record answers it.
