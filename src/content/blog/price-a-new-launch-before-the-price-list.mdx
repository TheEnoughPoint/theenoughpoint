...
Read the bold column first. Pay S$2,900 and the neighbourhood has to be **42% dearer than it is today** before you get your money back. That is the whole decision, it assumes nothing about how long you hold, and it is set entirely by a number nobody has seen yet.
...
The same caveat applies as to the land table: S$3,400 is one month's median, on roughly four units, at the tail of a nearly sold-out project. In May the same figure was S$3,361. And the sensitivity runs the way you would expect — a buyer who got in at S$3,100 rather than S$3,400 faces **+46%** instead of +60%. Which is the point of the whole exercise: the building does not change, the entry price does.
...
**Compute your own break-even.** Your entry price, times about 1.06, divided by S$2,162. That is how far the neighbourhood must rise, and it needs no view on how long you hold. Want it as an annual rate? Take the Nth root for the N years you would actually stay. If the answer is higher than what you honestly believe District 20 will do, the building is fine and the price is not.
