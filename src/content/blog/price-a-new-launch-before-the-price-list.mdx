...
Six things, in the order you would actually do them. Two at home, three in the room, and one that decides it.

**Before you go — run the affordability test at 4%**, not at the package rate the gallery quotes, and check the age-65 clause before you look at a single floor plan. [The calculator above](#first-gate-could-you-carry-it-at-all) does it; change the price and the age and watch the income bar move. If it does not clear, nothing else on this page matters.

**Before you go — write down your own break-even.** Your entry price, times about 1.06, divided by S$2,162 — recheck that figure, it moves — is how far District 20 must rise before you sell at cost. It needs no view on how long you hold. Decide *now*, in your kitchen, what number would be too high, because you will not decide it well standing in a sales gallery.
...
**Ask what any land price they quote includes.** This site is **S$714** a square foot before the government's extra charges and **S$1,178** after them. That is the same piece of land at two numbers 65% apart, and the lower one makes any asking price look better. If nobody in the room can tell you which you are being shown, it is not a number you can use.

**Ask the price of the size you want, not the project's average.** A 700 square foot flat and a 1,300 square foot one in the same building carry very different premiums, because each is competing with different homes nearby. A single figure for "the project" answers neither.

**Then compare the number you were given with the one you wrote down.** If the price list puts you above the break-even you set at home, the building is fine and the price is not. That is the whole decision, and you made it before anyone in the room could help you make it.

Do those six and you will walk in with everything the room cannot tell you already settled — which leaves you the only part that was ever yours: how long you would actually live there, how much cushion you want, and whether the trade between space now and newness later is one you want to make. That is a decision, not a calculation, and it is not ours to make.
