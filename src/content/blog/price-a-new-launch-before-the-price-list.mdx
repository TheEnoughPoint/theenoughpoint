...
<div class="tldr">
  ...
  <ul>
    ...
    <li><b>Ask the price of the size you want, not the project.</b> On one price list the gap over nearby resale runs <b>+18% to +76%</b> depending purely on unit size. The project does not have one premium.</li>
