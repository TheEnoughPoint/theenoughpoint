...
<CondoCompare defaults={['Jadescape', 'The Panorama', 'Thomson Three']} />

Thomson Reserve itself cannot appear as a fourth column, and the reason is the honest heart of this article: **it has no resale history, because nothing has been resold.** Six of the seven measures below simply do not exist for it yet. That is what you are accepting when you buy off a floor plan — not a worse building, but a building with no record, priced against buildings that have one.
