...
takeaways:
  ...
  - "Split them by the size of the flats instead and the gap is <strong>three and a half times wider</strong>: 3.58% against 3.23%. Districts of small flats yield more."
...
Do the same split. The thirteen districts with the smallest flats yield **3.58%**. The thirteen with the largest yield **3.23%**. That gap is **three and a half times** the one price produced — and unlike the price split, it holds steadily down the ranking rather than appearing only at the ends.
