...
cover: "/img/brand/cover-progressive-payment.svg"
date: "2026-08-08"
...
So we ran both purchases month by month. Same price, same 75% loan, same mortgage rate, same day of decision. One buyer takes a resale flat and moves in. The other buys off plan and rents while it is built. Both need a roof over exactly the same months, which is the part most comparisons quietly drop.
...
To hold a new launch you pay a **booking fee of 5%**, in cash, on the spot. To hold a resale flat you pay an **option fee of 1%**, and the other 4% about two weeks later when you exercise.
...
Now count the other side. The resale buyer moves in at month three and stops paying rent. The new-launch buyer pays rent for forty-three months.
...
A second case cuts the same way: a resale flat bought with a tenant in place collects rent from day one, which the buyer can put against the instalment. That is a different purchase with different risks, but it belongs in the honest version of the ledger.
...
**Renovation is excluded from both sides**, and it is usually the larger bill on a resale flat. That cuts against the direction of everything above, and we have left it out rather than guess at it.
