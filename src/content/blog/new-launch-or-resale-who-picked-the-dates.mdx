...
All figures in this table are Stacked Homes' computation (Sean Goh, 12 May 2021). We have not reproduced them. The **per year** columns are ours.

| Window | Launch, total gain | Resale, total gain | Launch, per year | Resale, per year |
| --- | --- | --- | --- | --- |
...
Here is the part that is easy to miss. Those three windows are not three different periods. **They all end on the same day** — 31 March 2021. They differ only in how far back they reach.

| Starts | Reaches back | Verdict, on the same annual basis |
| --- | --- | --- |
| 1995 | 26.2 years | Resale clearly ahead |
| 2011 | 10.2 years | New launch ahead by ~S$3,800 on S$1.5m |
| 2015 | 6.2 years | Cannot be compared |
