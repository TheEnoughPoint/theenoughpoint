...
The older, humbler answer: decide <em>in advance</em> what evidence would change what you hold, and write it down. A rule can be as simple as a line on a chart, and "So what do you do" below gives two shapes it can take. What matters is that the rule does the reacting, so that you do not have to.

That is also how the analyst whose video prompted this piece answers the question. Chris Ciovacco does not forecast rates. He checks whether the market's own internals show the damage that preceded the 2022 bear, using five checks of market health. In the weeks before the January 2022 top, none of the five passed. Today, on his figures, all five do. His evidence, his framework — we have not re-run it. The posture is the part worth borrowing: let evidence move you, or a pre-written rule. Never a headline.
