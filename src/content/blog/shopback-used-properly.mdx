...
That is the same principle as [knowing which S$5 plate beats the S$18 one](/cheap-eats-singapore): value living is not deprivation, it is intention. Decide the spending on its own merits. Then take the slice that was always on the table — it was yours to begin with.
